...
namespace UnitTest
{
    public class GetAll_UnitTesting
    {
        [Fact]
        public async Task GetAll_ShouldReturnReservationList()
        {
            // Arrange
            ...
            mockReservationQuery.Setup(x => x.GetAll(It.IsAny<int?>(), It.IsAny<int?>(), It.IsAny<int?>(), It.IsAny<Guid?>(), It.IsAny<DateOnly?>())).ReturnsAsync(new List<Reservation> { reservation1, reservation2 });
